...
void insert_ui(bst<int, int>& container) {
...
void modify_ui(bst<int, int>& container) {
    auto key = input_key_ui();
    auto value = input_value_ui();
...
void read_ui(bst<int, int>& container) {
    auto key = input_key_ui();

    std::cout << container[key] << std::endl << std::endl;
}

void remove_ui(bst<int, int>& container) {
    auto key = input_key_ui();

    std::cout << container.remove(key) << std::endl << std::endl;
}

void size_ui(bst<int, int>& container) {
    std::cout << container.size() << std::endl << std::endl;
}

void clear_ui(bst<int, int>& container) {
    container.clear();
    std::cout << std::endl << std::endl;
}

void empty_ui(bst<int, int>& container) {
    std::cout << container.empty() << std::endl << std::endl;
}

void depth_ui(bst<int, int>& container) {
    std::cout << container.depth() << std::endl << std::endl;
}

void keys_ui(bst<int, int>& container) {
...
void print_ui(bst<int, int>& container) {
    container.print(std::cout);
    std::cout << std::endl;
}

void iterator_ui(bst<int, int>::iterator& iterator, bst<int, int>& container) {
    int selected;
...
void reverse_iterator_ui(bst<int, int>::reverse_iterator& riterator, bst<int, int>& container) {
    int selected;
